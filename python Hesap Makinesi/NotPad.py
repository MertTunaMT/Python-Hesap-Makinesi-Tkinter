import sys
import os
from PyQt5.QtWidgets import QWidget, QApplication, QAction, QMainWindow, qApp, QTextEdit, QFileDialog,  QPushButton, QHBoxLayout, QVBoxLayout
